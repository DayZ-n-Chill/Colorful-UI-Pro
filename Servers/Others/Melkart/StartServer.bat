...
SET "MODS=P:\Mods\@Melkart_Official;"

:: ====================================================================================================================
::  NO NEED TO MODIFY ANYTHING ELSE, UNLESS YOU KNOW WHAT YOU'RE DOING!!!
:: ====================================================================================================================
SET "CLIENTLOGSDIR=%PROJECTDIR%\Servers\!ClientDiagLogs"
SET "MISSIONDIR=%PROJECTDIR%\Missions\Custom\empty.melkart"
SET "SERVERCFG=%PROJECTDIR%\Servers\Others\Melkart\serverDZ.cfg"
SET "PROFILES=%PROJECTDIR%\Servers\Others\Melkart\Profiles"

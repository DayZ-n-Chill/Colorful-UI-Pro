...
SET "MODS=P:\Mods\@Valning Map;"

:: ====================================================================================================================
::  NO NEED TO MODIFY ANYTHING ELSE, UNLESS YOU KNOW WHAT YOU'RE DOING!!!
:: ====================================================================================================================
SET "CLIENTLOGSDIR=%PROJECTDIR%\Servers\!ClientDiagLogs"
SET "MISSIONDIR=%PROJECTDIR%\Missions\Custom\dayzoffline.valning"
SET "SERVERCFG=%PROJECTDIR%\Servers\Others\Valning\serverDZ.cfg"
SET "PROFILES=%PROJECTDIR%\Servers\Others\Valning\Profiles"
...
:: Start local server.
start /D "%GAMEDIR%\" DayZDiag_x64.exe -server -filePatching "-mod=%GLOBALMODS%%MODS%" "-profiles=%CLIENTLOGSDIR%" "-mission=%MISSIONDIR%" "-config=%SERVERCFG%" "-newErrorsAreWarnings=1"
:: Play on local server.
start /D "%GAMEDIR%\" DayZDiag_x64.exe "-profiles=%PROFILES%" "-mod=%GLOBALMODS%%MODS%" -filePatching -connect=127.0.0.1 -port=2302 "-newErrorsAreWarnings=1"